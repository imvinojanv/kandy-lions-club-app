        ...
        <section className='mx-auto max-w-7xl px-4 py-20'>
            <div className='py-14 bg-blue rounded-2xl flex items-center justify-between'>
                <div className='flex flex-col w-[500px] justify-start pl-20'>
                    <h2 className='text-yellow text-4xl font-semibold'>Collaborate, Donate, Make a Difference!</h2>
                    ...
                    <div className='flex space-x-4 mt-8'>
                        ...
                        <button className="border border-white px-6 py-3 rounded-md font-medium">Schedule a call</button>
                    </div>
                </div>
                <Image 
